pipeline {
  ...
  environment {
    EXT_RELEASE_TYPE = 'github_tag'
    EXT_GIT_BRANCH = 'none'
    EXT_USER = 'qbittorrent'
    EXT_REPO = 'qBittorrent'
    BUILD_VERSION_ARG = 'QBITTORRENT_TAG'
    LS_USER = 'linuxserver'
    LS_REPO = 'pipeline-test-qbittorrent'
    DOCKERHUB_IMAGE = 'lspipelive/qbittorrent'
    DEV_DOCKERHUB_IMAGE = 'lspipetest/qbittorrent'
    PR_DOCKERHUB_IMAGE = 'lspipepr/qbittorrent'
    BUILDS_DISCORD = credentials('build_webhook_url')
    GITHUB_TOKEN = credentials('github_token')
    DIST_IMAGE = 'alpine'
    DIST_TAG = '3.7'
    DIST_PACKAGES = 'boost-system \
  	                 boost-thread \
  	                 ca-certificates \
  	                 geoip \
  	                 qt5-qtbase \
